from albert.entity.un_numbers import UnNumber, UnNumberCollection
...
def test_un_number_get_by(client):
    found_un = client.un_numbers.get_by_name("UN9006")
    assert isinstance(found_un, UnNumber)
    found_by_id = client.un_numbers.get_by_id(found_un.id)
